...
# FROM: umi_cluster/volume_build_init_node1.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseVolumeBuildInitNode1(HttpRunner):
    ...
    teststeps = [
        Step(
            ...
            .with_json({"req_host": "172.18.123.71", "dev_path": "/dev/sde"})
            .validate()
...
if __name__ == "__main__":
    TestCaseVolumeBuildInitNode1().test_start()
