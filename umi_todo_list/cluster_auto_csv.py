...
import xlwt
import yaml
from umi_cluster.restapi.cluster import cifs, cluster, iscsi, nfs, posix, user, volume, ftp, ctdb
from umi_cluster.restapi.node import network, storage, lvm
...
if __name__ == '__main__':
    ...
    # 修改这里，自定义文件名
    cumstom_file = "umi_cluster_test_summary"
